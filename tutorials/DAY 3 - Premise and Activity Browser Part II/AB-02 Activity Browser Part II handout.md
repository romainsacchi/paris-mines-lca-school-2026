# AB-02 Activity Browser Part II Handout

Instructor: Bernhard Steubing

## Purpose

This handout supports the second Activity Browser module after the Day 3 `premise` generation workflow.
The focus is on comparing scenarios, years, and technologies in the GUI.

## Before you start

- Activate the `lca-course` environment.
- Open Activity Browser and select `paris-lca-course-2026`.
- Confirm that the generated `paris-remind-eu-...` scenario databases are present.
